package com.dmd.base.constant;

/**
 * The class Global constant.
 *
 * @author dmd.net@gmail.com
 */
public class GlobalConstant {
	...
	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/dmd/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/dmd/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/dmd/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/dmd/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/dmd/seq";
	...
	public static final class Sys {
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "dmd/file/";
