...
import com.dmd.admin.mapper.SmsHomeNewProductMapper;
import com.dmd.admin.model.domain.SmsHomeNewProduct;
import com.dmd.admin.model.domain.SmsHomeNewProductExample;
import com.dmd.admin.service.SmsHomeNewProductService;
...
public class SmsHomeNewProductServiceImpl implements SmsHomeNewProductService {
    ...
    public int create(List<SmsHomeNewProduct> homeNewProductList) {
        for (com.dmd.admin.model.domain.SmsHomeNewProduct SmsHomeNewProduct : homeNewProductList) {
