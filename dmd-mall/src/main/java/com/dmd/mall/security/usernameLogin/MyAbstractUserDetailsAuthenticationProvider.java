 ...
 * @since
 */
public abstract class MyAbstractUserDetailsAuthenticationProvider implements
     ...
     * <code>MyUsernamePasswordAuthenticationToken</code>, these should also appear in this
     * method.
     *
     * @param userDetails as retrieved from the
     * {@link #retrieveUser(String, MyUsernamePasswordAuthenticationToken)} or
     * <code>UserCache</code>
    ...
    public Authentication authenticate(Authentication authentication)
            throws AuthenticationException {
        Assert.isInstanceOf(MyUsernamePasswordAuthenticationToken.class, authentication,
                () -> messages.getMessage(
                        "AbstractUserDetailsAuthenticationProvider.onlySupports",
                        "Only MyUsernamePasswordAuthenticationToken is supported"));
    ...
    protected Authentication createSuccessAuthentication(Object principal,
        ...
        MyUsernamePasswordAuthenticationToken result = new MyUsernamePasswordAuthenticationToken(
     ...
     * {@link #additionalAuthenticationChecks(UserDetails, MyUsernamePasswordAuthenticationToken)}
