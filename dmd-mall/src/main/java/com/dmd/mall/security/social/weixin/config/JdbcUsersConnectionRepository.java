...
public class JdbcUsersConnectionRepository implements UsersConnectionRepository {
    ...
    private ThreadLocal<Map<String,String>> tablePrefix = ThreadLocalUtil.threadLocal;
    ...
    public List<String> findUserIdsWithConnection(Connection<?> connection) {
        ...
        List<String> localUserIds = jdbcTemplate.queryForList("select userId from " + tablePrefix.get().get("prefix") + "UserConnection where providerId = ? and providerUserId = ?", String.class, key.getProviderId(), key.getProviderUserId());
    ...
    public Set<String> findUserIdsConnectedTo(String providerId, Set<String> providerUserIds) {
        ...
        return new NamedParameterJdbcTemplate(jdbcTemplate).query("select userId from " + tablePrefix.get().get("prefix") + "UserConnection where providerId = :providerId and providerUserId in (:providerUserIds)", parameters,
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new JdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix.get().get("prefix"));
    }
