...
public class MyDaoAuthenticationProvider extends MyAbstractUserDetailsAuthenticationProvider {
    ...
    protected final UserDetails retrieveUser(String username,
        ...
        try {
            this.getUserDetailsService().setLoginType(authentication.getLoginType());
    ...
    private void mitigateAgainstTimingAttack(MyUsernamePasswordAuthenticationToken authentication) {
        if (authentication.getCredentials() != null) {
            String presentedPassword = authentication.getCredentials().toString();
